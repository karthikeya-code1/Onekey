...
const STARS = [
  { top: "6%", left: "20%", size: 2, delay: "0.4s", dur: "3.5s" },
  { top: "12%", left: "78%", size: 1.5, delay: "1.1s", dur: "4.2s" },
  { top: "25%", left: "45%", size: 2.5, delay: "0.7s", dur: "2.9s" },
  { top: "33%", left: "85%", size: 1, delay: "2.0s", dur: "3.8s" },
  { top: "40%", left: "8%", size: 2, delay: "0.2s", dur: "4.6s" },
  { top: "52%", left: "65%", size: 1.5, delay: "1.5s", dur: "3.1s" },
  { top: "60%", left: "28%", size: 3, delay: "0.9s", dur: "5.1s" },
  { top: "72%", left: "82%", size: 2, delay: "1.8s", dur: "3.4s" },
  { top: "80%", left: "50%", size: 1, delay: "0.6s", dur: "4.3s" },
  { top: "87%", left: "12%", size: 2.5, delay: "2.2s", dur: "2.7s" },
  { top: "92%", left: "88%", size: 1.5, delay: "1.3s", dur: "3.9s" },
  { top: "4%", left: "55%", size: 1, delay: "2.7s", dur: "4.9s" },
  { top: "48%", left: "38%", size: 2, delay: "0.0s", dur: "3.2s" },
  { top: "18%", left: "95%", size: 1.5, delay: "1.6s", dur: "4.1s" },
  { top: "75%", left: "62%", size: 1, delay: "2.4s", dur: "3.7s" },
];
...
export function Signup() {
  ...
  const mutation = useMutation({
    mutationFn: async ({
      ...
      const res = await elysiaClient.auth["sign-up"].post({ email, password });
      if (res.error) {
        throw new Error(res.error.value?.message || "Signup failed");
      }
      return res.data;
    },
    onSuccess: () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-zinc-950 overflow-hidden p-4">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute top-1/4 left-1/3 w-64 h-64 rounded-full bg-violet-500/8 blur-[60px] animate-[orb2_7s_ease-in-out_infinite_alternate]" />
        <div className="absolute bottom-1/3 right-1/4 w-48 h-48 rounded-full bg-indigo-400/8 blur-[50px] animate-[orb1_9s_ease-in-out_infinite_alternate]" />
      ...
      <div className="w-full max-w-md z-10 transition-all duration-300">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-neutral-400">
            Create an account to manage keys & credits
          </p>
        </div>
